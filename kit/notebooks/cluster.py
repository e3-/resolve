...
from kit.core.custom_model import CustomModel
import numpy as np
from loguru import logger
...
class Clusterer(CustomModel):
    components_to_consider: list[tuple[BaseComponent, float, str]]
...
# %%
from kit.common.load_component import Load
from kit.core.temporal.timeseries import NumericTimeseries
