...
from new_modeling_toolkit.common import reserve
from new_modeling_toolkit.common import zone
from new_modeling_toolkit.common.asset import tx_path
...
class System(component.Component):
    ...
    hourly_energy_policies: dict[str, policy.HourlyEnergyStandard] = Field({}, data_filepath="policies")
    ...
    @property
    def operations_assets(self):
        return self.plants | self.resources | self.tx_paths | self.fuel_production_plants | self.fuel_storages

    @property
    def policies(self):
        """Superset of all `Policy` child classes."""
        return self.emissions_policies | self.energy_policies | self.prm_policies | self.hourly_energy_policies
