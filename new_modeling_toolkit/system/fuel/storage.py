...
class FuelStorage(plant.Plant):
    ...
    fuel_storage_duration: Optional[PositiveFloat] = Field(
        ...
        "Exclusive of "
        ":py:attr:`new_modeling_toolkit.fuel_system.fuel_storage.FuelStorage.planned_storage_capacity`.",
        default_freq="YS",
        up_method="ffill",
        down_method="annual",
    )
    planned_storage_capacity: Optional[ts.NumericTimeseries] = Field(
        ...
        "Exclusive of "
        ":py:attr:`new_modeling_toolkit.fuel_system.fuel_storage.FuelStorage.duration`.",
        default_freq="YS",
        up_method="ffill",
        down_method="annual",
    )
    ...
    new_fuel_storage_fixed_om_by_vintage: Optional[ts.NumericTimeseries] = Field(
        ...
        ":py:attr:`new_modeling_toolkit.system.fuel.fuel_storage.FuelStorage.new_fuel_storage_capacity_fixed_cost_dollars_per_mmbtu_yr_by_vintage`",
        default_freq="YS",
        up_method="interpolate",
        down_method="annual",
    )
