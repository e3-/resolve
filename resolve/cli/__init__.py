...
from resolve.resolve.run_opt import main as resolve
...
def run(
    cases: list[str] = typer.Argument(None, help="List of CASEs to run"),
    solver: str = typer.Option("gurobi", help="Solver to use (cbc, gurobi)"),
    symbolic_solver_labels: bool = typer.Option(False, help="Use human-readable variable names in lp file"),
    data_folder: str = typer.Option("data", help="Path to the data folder"),
    extras: str = typer.Option(None, help="Enables a 'extras' module (RESOLVE)"),
