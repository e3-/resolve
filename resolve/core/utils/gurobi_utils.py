...
_REQUEST_TIMEOUT = (3.05, 30)  # (connect, read) seconds
...
class GurobiCredentials:
    ...
    def from_license_file(cls, license_path: os.PathLike):
        ...
        instance = cls(
            ...
            cloud_access_id=str(license_variables.get(_GUROBI_LICENSE_CLOUDACCESSID_VARIABLE_NAME, "")),
            secret_key=str(license_variables.get(_GUROBI_LICENSE_CLOUDKEY_VARIABLE_NAME, "")),
            license_id=str(license_variables.get(_GUROBI_LICENSE_LICENSEID_VARIABLE_NAME, "")),
