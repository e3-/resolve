...
from resolve.core import custom_constraint
...
from resolve.system.electric.caiso_tx_constraint import CaisoTxConstraint
...
from resolve.system.electric.resources import ElectricResource
from resolve.system.electric.resources import FlexLoadResource
from resolve.system.electric.resources import FlexLoadResourceGroup
from resolve.system.electric.resources import GenericResource
from resolve.system.electric.resources import HybridStorageResource
from resolve.system.electric.resources import HybridVariableResource
from resolve.system.electric.resources import HydroResource
from resolve.system.electric.resources import ShedDrResource
...
from resolve.system.electric.resources import ThermalUnitCommitmentResource
...
from resolve.system.fuel.final_fuel import FinalFuel
...
from resolve.system.generics.generic_linkages import ZoneToDemand
from resolve.system.generics.generic_linkages import ZoneToPlant
...
from resolve.system.sector import Sector
...
class System(Component):
        ...
        for group in tqdm(
            ...
            if "ReliabilityContribution" in self.linkages:
                ...
                for linkage in self.linkages["ReliabilityContribution"]:
                    if linkage.instance_from == group:
                        # Remove linkage from corresponding group. Linkage remains on member assets
            ...
            if "ERMContribution" in self.linkages:
                ...
                for linkage in self.linkages["ERMContribution"]:
                    if linkage.instance_from == group:
                        # Remove linkage from the group as ERM contributions will take place at the vintage level
    ...
    def resample_ts_attributes(
        ...
        # Custom constraints with modeled year hourly profiles
        for cc_rhs in self.custom_constraints_rhs.values():
            cc_rhs.update_hourly_target_by_modeled_year(modeled_years=modeled_years, weather_years=weather_years)
        for cc_lhs in self.custom_constraints_lhs.values():
            cc_lhs.update_hourly_multiplier_by_modeled_year(modeled_years=modeled_years, weather_years=weather_years)
