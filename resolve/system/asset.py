...
class Asset(BaseAsset, Component):
    """An Asset is anything with a cost & quantity."""

    _DOCS_URL: ClassVar[str] = (
        "https://docs.ethree.com/projects/kit/en/resolve-refactor-test-case-v4/system/index.html#resolve.system.asset.Asset."
    )
    ...
    #################################
    vintage_parent_group: Optional[str | None] = Field(None, title="Vintage Parent Group")
