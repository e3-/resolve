...
class Resource(Plant):
    ...
    Attributes removed relative to ``RESOLVE`` resources:
        ...
        - Removed as unuseful:
            ...
            - ``energy_borught_online_mwh`` (merged with :py:attr:`resolve.common.resource.Resource.provide_power_potential_profile`)
            - ``shape`` (renamed :py:attr:`resolve.common.resource.Resource.provide_power_potential_profile`)
    """
    ...
    unit_commitment_linear: bool = Field(
        ...
        "Exclusive of :py:attr:`resolve.common.resource.Resource.unit_commitment_integer`.",
    )
    unit_commitment_integer: bool = Field(
        ...
        "Exclusive of :py:attr:`resolve.common.resource.Resource.unit_commitment_linear`.",
    )
    ...
    duration: Optional[PositiveFloat] = Field(
        ...
        "Exclusive of :py:attr:`resolve.common.resource.Resource.planned_storage_capacity`.",
        default_freq="YS",
        up_method="ffill",
        down_method="annual",
    ...
    planned_storage_capacity: Optional[ts.NumericTimeseries] = Field(
        ...
        "Exclusive of :py:attr:`resolve.common.resource.Resource.duration`.",
        default_freq="YS",
        up_method="ffill",
        down_method="annual",
    ...
    new_storage_capacity_fixed_om_by_vintage: Optional[ts.NumericTimeseries] = Field(
        ...
        description=(
            ...
            ":py:attr:`resolve.common.resource.Resource.new_provide_power_capacity_annualized_fixed_cost` "
