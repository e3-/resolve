...
summary_sheet_mapping = [
    ...
    ("annual_load_components_summary.csv", "Load Components"),
    ("asset_summary.csv", "Asset Summary"),
    # ("../constraints/Custom_Constraint.csv", "Custom Constraints"),
    ("electrolyzer_summary.csv", "Electrolyzer"),
    ("emissions_policy_resource_summary.csv", "Emissions Policy Resource"),
    ("emissions_policy_tx_path_summary.csv", "Emissions Policy TxPath"),
    ("energy_policy_summary.csv", "Energy Policy Summary"),
    ("fuel_conversion_plant_summary.csv", "Fuel Conversion"),
    ("fuel_storage_summary.csv", "Fuel Storage"),
    ("fuel_transportation_summary.csv", "Fuel Transport"),
    ("non_optimized_system_costs_summary.csv", "System"),
    ("policy_summary.csv", "Policy Summary"),
    ("prm_policy_resource_summary.csv", "PRM Resource Summary"),
    ("resource_fuel_burn_summary.csv", "Resource Fuel Burn"),
    ("resource_summary.csv", "Resource Summary"),
    ("temporal_settings_summary.csv", "Temporal Settings"),
    ("transmission_summary.csv", "Transmission Summary"),
    ("zonal_summary.csv", "Zonal Summary"),
...
def populate_excel_results_viewer(case_name_and_timestamp: str, wb: Optional["Book"] = None):
    ...
    results_path = upath.UPath(case_name_and_timestamp) / "results_summary"
